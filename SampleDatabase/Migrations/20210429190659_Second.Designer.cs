...
namespace SampleDatabase.Migrations
{
    ...
    [Migration("20210429190659_Second")]
            ...
            modelBuilder.Entity("SampleDatabase.PostEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2021, 4, 29, 21, 6, 59, 284, DateTimeKind.Local).AddTicks(595),
                            Text = "My Text"
                        },
                        new
                        {
                            Id = 2,
                            CreateDate = new DateTime(2021, 4, 29, 21, 56, 59, 287, DateTimeKind.Local).AddTicks(849),
                            Text = "My Text 2"
                        },
                        new
                        {
                            Id = 3,
                            CreateDate = new DateTime(2021, 4, 29, 20, 16, 59, 287, DateTimeKind.Local).AddTicks(903),
                            Text = "My Text 3"
                        });
                });
